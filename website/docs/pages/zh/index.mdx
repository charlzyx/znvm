...
<HomePage.Root>
  <HomePage.Logo />
  <HomePage.Tagline>**znvm** — Zig 驱动的 NVM。</HomePage.Tagline>
  <HomePage.Description>
    零负担 Node 版本管理器。终极 **nvm 替代品**，解决 **nvm 卡顿** 问题。
    启动仅需 &lt; 5ms。Unix 优先，零配置，兼容现有的 `.nvmrc`。
  </HomePage.Description>
  <HomePage.Buttons>
    <HomePage.Button href="/zh/getting-started" variant="accent">快速开始</HomePage.Button>
