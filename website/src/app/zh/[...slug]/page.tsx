...
// 获取页面内容
async function getPageContent(slug: string[], lang: string = "zh") {
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const pageContent = await getPageContent(resolvedParams.slug, "zh");
...
export async function generateStaticParams(): Promise<{ slug: string[] }[]> {
  const contentDir = path.join(process.cwd(), "content", "zh");
